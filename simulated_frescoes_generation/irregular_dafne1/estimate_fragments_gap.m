% This function estimates the mean distance between adjacent fragments.
% 
% Inputs:
...
% 
% Outputs:
%   * ifd:            distance estimate between adjacent fragments
%   * out_frags_sol:  output collection of fragments
function [ifd2,frags_sol_out] = estimate_fragments_gap( im_rec, frags_sol_in )
    ...
    for i=1:nb_frags
        ...
        % We estimate adjacent fragments from the current one by intersecting the union of 
    ...
    % Second distance estimate is taken as the median of all minimum distances between found couples of adjacent fragments
    ifd2 = median(ifd2);
end