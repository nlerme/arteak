% Function returning interpolated image intensities. Pixel coordinates are assumed to lie into the image domain.
% 
% Inputs:
%   * im_src:              multi-channels image
%   * coords:              pixel coordinates (n x 2 matrix of reals [py_1,px_1;...;py_1,px_n])
%   * interpolation_type:  type of interpolation (e.g. nearest, bilinear, bicubic, etc.)
% 
% Outputs:
