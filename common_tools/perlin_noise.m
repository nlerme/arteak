...
%   * nb_octaves:   number of octaves (positive integer)
%   * persistence:  scalar used for weighting filtered images (in [0,1])
% 
% Outputs:
%   * im_result:  resulting image with normalized intensities in [0,1]
function im_result = perlin_noise( image_size, nb_octaves, persistence )
    ...
    % We normalize the intensities of the output image
