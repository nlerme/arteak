...
function run_reconstructions()
    ...
    function main()
        ...
        data_root_dir    = ['..' filesep '..' filesep 'data' filesep 'irregular'];
        %--------------
...
%         end
    ...
    function run_reconstruction( data_root_dir, fresco_name, config_name, results_root_dir )
        ...
        parfor k=1:numel(frag_fns)
            msg(sprintf('  + fragment %d/%d', k, numel(frag_fns)));
        ...
        %                                                                          results_dir, gt_fn, verbose, show_figures);
        ...
        % We save the reconstructed fresco image and and fragments
        %save_registered_fragments_list(final_frags_sol, frags_infos, [results_dir filesep 'final_rec_frags.txt']);
        return;
