% This function saves the set of [rotated] [eroded] fragment images.
% 
% Inputs:
...
% Outputs:
%   None
function [im_frags4,frag_angles] = save_fragments_images( im_frags3, erosion_radius, use_rotated_fragments, angles_list, fragment_size, frags_dir )
